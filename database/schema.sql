...
CREATE TABLE users (
    ...
    notification_before_minutes SMALLINT UNSIGNED NOT NULL DEFAULT 10,
    notification_after_minutes SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    notify_entry_enabled TINYINT(1) NOT NULL DEFAULT 1,
    notify_lunch_start_enabled TINYINT(1) NOT NULL DEFAULT 1,
    notify_lunch_return_enabled TINYINT(1) NOT NULL DEFAULT 1,
    notify_clock_out_enabled TINYINT(1) NOT NULL DEFAULT 1,
